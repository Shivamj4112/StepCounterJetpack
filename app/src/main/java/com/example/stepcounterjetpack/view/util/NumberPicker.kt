...
//     */
//    var selectedTextStrikeThru: Boolean
//
//    /**
//     * Flag whether the selected text should underlined.
//     */
//    var selectedTextUnderline: Boolean
//
//    /**
...
//                        val deltaDownX =
//                            abs((currentMoveX - mLastDownEventX).toDouble()).toInt()
...
//                    if (mScrollState != OnScrollListener.SCROLL_STATE_TOUCH_SCROLL) {
//                        val deltaDownY =
//                            abs((currentMoveY - mLastDownEventY).toDouble()).toInt()
...
//                        val deltaMoveX =
//                            abs((eventX - mLastDownEventX).toDouble()).toInt()
...
//                        val deltaMoveY =
//                            abs((eventY - mLastDownEventY).toDouble()).toInt()
...
//        } else {
//            for (displayedValue: String in displayedValues!!) {
...
//                mSelectorWheelPaint.textAlign =
//                    Paint.Align.entries.toTypedArray()[selectedTextAlign]
...
//            } else {
//                mSelectorWheelPaint.textAlign =
//                    Paint.Align.entries.toTypedArray()[textAlign]
...
//                .toTypedArray()
//            val height =
//                ((abs((paint.descent() + paint.ascent()).toDouble()) * lineSpacingMultiplier).toFloat())
...
//                min(size.toDouble(), maxSize.toDouble())
...
//            val desiredWidth =
//                max(minSize.toDouble(), measuredSize.toDouble()).toInt()
...
//            abs((position - currentPosition).toDouble()).toInt()
//        )
//    }
//
//    /**
...
//        return if ((mFormatter != null)) mFormatter!!.format(value) else formatNumberWithLocale(
//            value
//        )
//    }
//
...
//
//        // input text
//        mSelectedText = findViewById<EditText>(R.id.np__numberpicker_input)
...
//                for (`val`: String in displayedValues!!) {
...
//        get() = order == ASCENDING
//    var dividerColor: Int get() = mDividerColor
//        set(color) {
//            mDividerColor = color
...
//            mWheelItemCount = max(count.toDouble(), DEFAULT_WHEEL_ITEM_COUNT.toDouble())
//                .toInt()
...
//         */
//        private val DEFAULT_DIVIDER_COLOR = -0x1000000
//
//        /**
...
//         */
//        private val DEFAULT_WHEEL_ITEM_COUNT = 3
//
//        /**
